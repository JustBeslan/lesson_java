...
//====================Attempt Number2=============================
        ...
        project2.addWorker(project1Manager1);
        //------------------------
        worker1_1_1.addProject(project2, 1.0);
        project2.addWorker(worker1_1_1);
        worker1_1_3.addProject(project2, 1.1);
        project2.addWorker(worker1_1_3);
        worker1_1_4.addProject(project2, 1.1);
        project2.addWorker(worker1_1_4);
        worker1_1_5.addProject(project2, 1.1);
        project2.addWorker(worker1_1_5);
        ...
        project2.addWorker(worker1_2_3);
        worker1_2_4.addProject(project2, 2.1);
        project2.addWorker(worker1_2_4);
        worker1_2_5.addProject(project2, 2.1);
        project2.addWorker(worker1_2_5);
        ...
        project2.addWorker(worker1_3_2);
        worker1_3_3.addProject(project2, 3.1);
        project2.addWorker(worker1_3_3);
    ...
    public void indTest() {
        ...
        projects.get(0).addWorker(newWorker);
