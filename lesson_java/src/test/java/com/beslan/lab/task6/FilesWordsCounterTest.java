...
class FilesWordsCounterTest {
    ...
    void FilesWordsCounterTest1() throws IOException {
        FilesWordsCounter filesWordsCounter1 = new FilesWordsCounter("C:/Project_Java/lesson_java/src/main/resources/test1/");
    ...
    void FilesWordsCounterTest2() throws IOException {
        FilesWordsCounter filesWordsCounter2 = new FilesWordsCounter("C:/Project_Java/lesson_java/src/main/resources/test2/");
